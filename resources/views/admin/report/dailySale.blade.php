  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Daily Item Sale</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card">
          <form action="{{route('admindailySaleFilter')}}" method="post">
            @csrf
            <div class="row">
              ...
              <div class="col-4 ml-5"> 
                <div class="p-4">                    
                  <label for="exampleInputDate" class="mt-3 mb-3 d-block form-check-label">Enter Date</label>
                    <input type="date" class="form-control @error('date') is-invalid @enderror" id="exampleInputDate" placeholder="Enter Expense Date" name="date">
        ...
        <div class="card">
          <table id="example2" class="table table-bordered table-hover">
            ...
            <tbody>
              ...
              <tr><td colspan="4"><b>DATE: {{$date}}</b></td></tr>
              @php                                    
                  $myArray = array();
              @endphp
