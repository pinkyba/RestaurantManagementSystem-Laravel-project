  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Month Item Sale Report</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{route('dashboardpage')}}">Home</a></li>
              <li class="breadcrumb-item active">Month Item Sale</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card">
          <form action="{{route('adminmonthSaleFilter')}}" method="post">
            @csrf
            <div class="row">
              ...
              <div class="col-4 ml-5"> 
                <div class="p-4">                    
                  ...
                  <select class="form-select form-select-lg mb-3 form-control" aria-label=".form-select-lg example" name="restaurant_id">
              ...
              <div class="col-4 ml-5"> 
                <div class="p-4">                    
                  <label class="mt-3 mb-3 d-block form-check-label">Choose Month</label>
                  
                  <select class="form-select form-select-lg mb-3 form-control" aria-label=".form-select-lg example" name="month">
                    @php
        ...
        <div class="card">
          <table id="example2" class="table table-bordered table-hover">
            ...
            <tbody>
              ...
              <tr><td colspan="4"><b>MONTH: {{$month}}</b></td></tr>
              @php                                    
                  $myArray = array();
              @endphp
