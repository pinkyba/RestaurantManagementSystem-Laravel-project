        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Expense Category Form</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">  
                <h2 class="d-inline">Expense Category Form</h2>              
              ...
              <div class="card-body">
                <form action="{{route('expense_categories.store')}}" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="exampleInputName" placeholder="Expense Category Name" name="name">
                    @error('name')
