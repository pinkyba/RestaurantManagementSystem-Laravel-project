@extends('barcounterstaff_master')
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="mb-3">Bar Order Details by {{$order->table->name}}</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{route('barcounterstaffdashboard')}}">Home</a></li>
              <li class="breadcrumb-item active">Bar Order Details</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                ...
                <ul class="nav flex-column">
                  ...
                  <li class="nav-item">
                    @if($menu_item->pivot->status == 'order')
                      <a href="{{route('orders_confirm',['orderid'=>$order->id,'menuid'=>$menu_item->id,'status'=>'bar'])}}" class="nav-link">
