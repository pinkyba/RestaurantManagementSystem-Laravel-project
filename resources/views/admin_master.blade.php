      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="{{route('dashboardpage')}}" class="nav-link {{Request::is('dashboard*')? 'active':''}}">
          ...
          <li class="nav-item">
            <a href="{{route('restaurantInfos.index')}}" class="nav-link {{Request::is('restaurantInfos*')? 'active':''}}">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Restaurant Info
                <i class="fas fa-angle-left right"></i>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('restaurantInfos.index')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>All Restaurants</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{route('restaurantInfos.create')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Restaurant</p>
                </a>
              </li>
